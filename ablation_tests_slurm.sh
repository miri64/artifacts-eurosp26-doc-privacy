...
srun "${PWD}"/ablation_tests.sh -c dt -s 8 -p coaps         -D json -d dns_message -d dns_cbor  -r "${RUN}" -v binvec : \
     "${PWD}"/ablation_tests.sh -c dt -s 8 -p coap -p https -D json -d dns_message -d dns_cbor  -r "${RUN}" -v binvec : \
     ...
     "${PWD}"/ablation_tests.sh -c dt -s 8 -p coap -p https -D cbor -d dns_message -d dns_cbor  -r "${RUN}" -v binvec : \

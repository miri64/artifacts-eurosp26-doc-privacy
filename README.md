...
Or download the `artifacts-eurosp26-doc-privacy-v1.1.0.zip` ZIP archive from [Zenodo][software-doi] and unzip it in the git repository.
...
- **8. Discussion** does not have any code. The numbers we discuss in this section we took from [`05_ml_to_identify_dns_traffic.ipynb`](./05_ml_to_identify_dns_traffic.ipynb) and [`06_evaluation.ipynb`](./06_evaluation.ipynb).
...
[paper-doi]: https://doi.org/10.1109/EuroSP68448.2026.00094
